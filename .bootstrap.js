...
const PROJECT_NAME = "arbitrage-nexus-xqf1ccyg";
...
function runSetupCommands() {
    const commands = [
    "bun add @paypal/checkout-server-sdk@^1.0.3 numeral@^2.0.6",
    "bun add numeral@^2.0.6",
    "bun add lucide-react clsx tailwind-merge framer-motion zustand next-themes@latest",
    "bun add numeral",
    "bun add lucide-react@0.453.0 numeral@^2.0.6",
